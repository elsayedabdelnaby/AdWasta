...
const PIPELINE = [
  { key: 'research', label: 'Research (Alex)', path: '/research/run' },
  { key: 'strategy', label: 'Strategy (Sam)', path: '/strategy/generate' },
  { key: 'content', label: 'Creation (Jordan)', path: '/content/recommend' },
] as const;
  ...
  async function runPipeline() {
    ...
    try {
      for (const s of PIPELINE) {
        ...
        try {
          await api.post(`/tenants/${tenantId}${s.path}`, {});
