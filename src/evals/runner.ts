...
if (isMain) {
  ...
  const RULES_BY_PILLAR: Record<string, typeof researchRules> = { research: researchRules, strategy: strategyRules, creation: creationRules, measure: measureRules, 'daily-brief': briefRules };
